...
import gov.noaa.noaainterface.ui.components.supportprofiles.editor.dtos.Address;
...
public class AreaOfConcernLayout extends VerticalLayout implements ValidatableForm<AreaOfConcern> {
    ...
    private OpenLayersMapSupportProfiles openLayersMap = new OpenLayersMapSupportProfiles();
